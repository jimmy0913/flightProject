   ...
   function pickerDateRange(inputId, options) {
     ...
     */
     var defaults = {
        ...
        clear : function(obj) {return true;}, //回调函数，选择日期之后执行何种操作
    ...
    var wrapper = {
      ...
      '<div class="ta_calendar_cont cf" id="'+ this.dateListId +'">',
          ...
          '</div>',
          '<div class="frm_btn">',
          '<a id="' + this.mOpts.aRecent7Days + '" href="javascript:void(0)"  >最近7天</a>',
          '<a id="' + this.mOpts.aRecent30Days + '" href="javascript:void(0)"  >最近30天</a>',
...
pickerDateRange.prototype.closeAll = function() {
  $(".ta_calendar").css('display', 'none');
};
/**
 * @description 清空日期选择框
 * @param {Boolean} btnSubmit 是否是点击确定按钮关闭的 
